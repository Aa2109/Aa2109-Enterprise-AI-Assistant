...
The supervisor + specialists path is the only execution flow. Tool
execution and human-approval interrupts now live in the specialist
agents (``app/agents/specialists/``) and the approval workflow elsewhere.
"""
